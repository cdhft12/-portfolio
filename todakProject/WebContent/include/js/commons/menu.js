...
function superSideBar(sideBarName){
   ...
   else if (sideBarName == "모금액 조회") 
      superSbList = [['전체', '/sponsor/selectSponsorship.td'], 
                        ['개인별', '#'], 
                        ['단체별', '#']];
   else {
      superSbList = [];
...
function listing(data){
   ...
   // 새로운 사이드바 영역확보하기
   $(".sidebar-wrap").css("display", "table-cell").css("width", '40%').css("vertical-align", 'top');
