			...
			%>
				<div class="sponsorship-info-wrap" align="center";>
					...
					<colgroup>
						...
						<tr>
							<td style="text-align:center; font-weight: bold; border-bottom : 1px solid #eeeeee;" >사업분야</td>
							<td style="border-bottom : 1px solid #eeeeee ;"><%= ssvo.getSc_bizfield() %></td>
						</tr>
						<tr>
							<td style="text-align:center; font-weight: bold; border-bottom : 1px solid #eeeeee;">사업내용</td>
				 ...
				 <br>
					...
					<colgroup>
						...
						<tr>
							<td style="text-align:center; font-weight: bold; border-right : 1px solid #eeeeee;" colspan="3">목표기간</td>
							<td style="text-align:center; font-weight: bold;  border-right : 1px solid #eeeeee;">목표금액</td>
							<td style="text-align:center; font-weight: bold;  border-right : 1px solid #eeeeee;">누적후원금액</td>
						...
						<tr>
							...
							<td> ~ </td>
							<td style="border-right : 1px solid #eeeeee;"><%= new StringBuffer(ssvo.getSc_amountingend()).insert(6, "-").insert(4, "-").toString() %></td>
							<td style="border-right : 1px solid #eeeeee;"><%= targetAmount %> 원</td>
							<td id="now_amount" style="border-right : 1px solid #eeeeee;">0</td>
			...
			%>
				<div class="sponsorship-info-wrap" align="center";>
					<table id="sponsorship-info" class="sponsorship-business">
						...
						<tr>
							<td style="text-align:center; font-weight: bold; border-bottom : 1px solid #eeeeee;" >누적 후원건수</td>
							<td style="border-bottom : 1px solid #eeeeee ;"><%= countSponsorship %> 건</td>
						</tr>
						<tr>
							<td style="text-align:center; font-weight: bold; border-bottom : 1px solid #eeeeee;">누적 후원금액</td>
