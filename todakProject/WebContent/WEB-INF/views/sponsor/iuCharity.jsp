			...
			<div class="inserttable_size">
				<form id="registerForm">
					<table class="insert_table" align="center" border="1">
						<tr>
							<td align="center" width="140" align="center" style="background-color:#eeeeee;color:black;">단체명</td>
							<td colspan="2" width="250">
								<input type="text" name="sc_name" id="sc_name" style="width:210px;" value=<%= scvo.getSc_name() %>>
							</td>
						</tr>
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">대표자</td>
							<td colspan="2">
								<input type="text" name="sc_ceo" id="sc_ceo" style="width:210px;" value=<%= scvo.getSc_ceo()%>>
							</td>
						</tr>
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">휴대폰번호</td>
							<td colspan="2">
								<input type="text" name="sc_hp" id="sc_hp" style="width:210px;" value=<%= scvo.getSc_hp() %>>&nbsp;&nbsp;<font size="2">* '-'구분자 없이 숫자 11자리</font>
							</td>
						</tr>
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">이메일</td>
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">소재지</td>
							<td colspan="2">
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">단체 등록번호</td>
							<td colspan="2">
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">단체 등록일</td>
							<td><input type="text" name="sc_registrationdate" id="sc_registrationdate" size="13"  value=<%= registrationdate %>></td>
						</tr>
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">사업분야</td>
							<td>
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">사업내용</td>
							<td colspan="2">
								<textarea name="sc_bizcontents" id="sc_bizcontents" rows="4" cols="60"><%= scvo.getSc_bizcontents() %></textarea>
							</td>
						</tr>
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">목표 모금액</td>
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">모금기간</td>
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">은행</td>
							<td colspan="2">
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">계좌번호</td>
							<td colspan="2">
						...
						<tr>
							<td align="center" style="background-color:#eeeeee;color:black;">예금주명</td>
