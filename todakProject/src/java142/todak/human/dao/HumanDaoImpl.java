...
//	public class HumanDaoImpl extends SqlSessionDaoSupport implements HumanDao {
	...
	public List<HboardVO> selectHboard(MemberVO mvo){
		return session.selectList("selectHboard");
	}
	@Override
	public List<HboardVO> boardDetail(HboardVO hvo){
		return session.selectList("boardDetail");
	}
	@Override
	public int boardAccept(HboardVO hvo){
		return session.update("boardAccept");
	}
	@Override
	public int boardHit(HboardVO hvo){
		return session.update("boardHit");
	}
	@Override
...
//		return getSqlSession().selectOne("HumanMemberApprovalVO");
	...
	@Override
	public int insertHboard(HboardVO hvo){
		return (int)session.insert("insertHboard");
	}
	@Override
	public int deleteHboard(HboardVO hvo){
		return (int)session.update("deleteHboard");
	}
	
	@Override
	public int updateHboard(HboardVO hvo){
		return (int)session.update("updateHboard");
	}
	
	@Override
	public HboardVO uploadSelect(HboardVO hvo){
		return session.selectOne("uploadSelect");
	}
	...
	public HboardVO selectPost(HboardVO hvo){
		return session.selectOne("selectPost");
	}
	@Override
